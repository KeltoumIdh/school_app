    ...
    const onSubmit = async (e) => {
      ...
      if (!isSigningIn) {
        ...
        try {
          ...
          await doSendEmailVerification(); // Appel de la fonction doSendEmailVerification après connexion réussie
        } catch (error) {
          setErrorMessage(error.message);
        }
        setIsSigningIn(false);
      }
      useUserStore.setState({ user: { email: email, password: password } });
    };
